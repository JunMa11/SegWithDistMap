...
parser.add_argument('--model', type=str,  default='vnet_sup_SDF', help='model_name')
...
def test_calculate_metric(epoch_num):
    net = VNetMultiTask(n_channels=1, n_classes=num_classes, normalization='batchnorm', has_dropout=False).cuda()
